...
const { facebook, google } = require("../controllers/signFBandGoogle");

const { createUser, getDetailUser, updateUser, deleteUser, login, updatePassword, completeSignUp } = require("../controllers/user");
