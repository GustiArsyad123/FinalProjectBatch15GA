...
const {
  createRecipeOneValidator,
} = require("../middlewares/validators/createRecipeOneValidator");
const {
  createRecipeTwoValidator,
} = require("../middlewares/validators/createRecipeTwoValidator");
const {
  createRecipeThreeValidator,
} = require("../middlewares/validators/createRecipeThreeValidator");
const {
  createRecipeFourValidator,
} = require("../middlewares/validators/createRecipeFourValidator");
...
router.get("/mobile", authentication, getAllRecipeMobile);
